...
export function GoogleSignInButton({ redirectTo }: { redirectTo?: string }) {
  ...
  return (
    <button type="button" onClick={handleSignIn} className="btn-secondary w-full gap-2">
      <svg width="18" height="18" viewBox="0 0 48 48" aria-hidden>
        ...
        <path
          fill="#4CAF50"
          d="M24 44c5.5 0 10.4-1.9 14.3-5.1l-6.6-5.4C29.6 35.4 26.9 36 24 36c-5.2 0-9.6-3.3-11.3-8l-6.6 5.1C9.6 39.6 16.3 44 24 44z"
        />
        <path
          fill="#1976D2"
          d="M43.6 20.5H42V20H24v8h11.3c-.8 2.3-2.2 4.2-4.1 5.5l6.6 5.4C41.9 35.9 44 30.4 44 24c0-1.3-.1-2.7-.4-3.5z"
        />
      </svg>
